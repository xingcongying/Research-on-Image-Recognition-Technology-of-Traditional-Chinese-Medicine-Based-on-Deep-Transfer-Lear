...
train_num = 13399  # 训练集的图片数量
test_num = 2666  # 测试集的图片数量

epochs = 60 # epoch数目
batch_size = 16  # 批次大小
classes = 80 # 样本分类数目
model_name = "idadp_test_60_16.h5" # model的名称
...
model = dense_net(blocks=[6, 12, 48, 32], input_shape=(300, 200, 3), classes=60)
...
output = open("./train_history0310.txt", "w+")
